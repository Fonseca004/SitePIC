...
const $$NavbarEn = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$NavbarEn;
  const menuitems = [
    {
      title: "About Us",
      path: "/en/about"
